...
string tstr="";
//cout<<retHex(keysBin[z])<<endl;
//cout<<retHex(Ev[z])<<endl;
for(i=0;i<48;i++)
{
	tstr="";
	tstr+=Ev[z][i];
...
//cout<<retHex(nR[z])<<endl;
//cout<<retHex(nR[z])<<" "<<retHex(L[z])<<" "<<retHex(nL[z])<<" "<<retHex(nR[z])<<" "<<retHex(R[z])<<endl;
// xor again
for(i=0;i<32;i++)
{	
	tstr="";
